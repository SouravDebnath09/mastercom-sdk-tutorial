...
public class SingleMessageDetail {
  ...
  **/
  ...
  @ApiModelProperty(example = "USA", value = "Acquirer Country")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "NEWYORK", value = "Acquirer Address City")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Acquirer Adjustment Settlement Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CR", value = "Acquirer Adjustment Settlement Amount Indicator")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Acquirer Adjustment Settlement Completion Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Acquirer Adjustment Settlement Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4000000", value = "Acquirer Advice Reason Code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "999663", value = "Acquirer Bridged ICA ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10011", value = "Acquirer Currency Conversion Rate")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1900053380", value = "Displays the routing and transit number of the customer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.00", value = "Acquirer Interchange Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Acquirer Interchange Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SampleName", value = "Debit Mastercard field only. Acquirer Name is a card acceptor identification code assigned by the merchant.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9000001607", value = "Acquirer processor number")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Acquirer Settlement Completion Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Acquirer Settlement Completion Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "11000000", value = "Acquirer Settlement Conversion Rate")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "000", value = "Additional Advice")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "12452234", value = "Additional POS Data")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0111111", value = "A code that provides additional supporting data pertaining to the response code associated with the transaction")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4000000", value = "Adjustment Advice Reason")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Adjustment Cashback Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "140626", value = "Date the adjustment is performed. YYMMDD")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Adjustment Purchase Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Y", value = "AFA Member")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5555555555555555", value = "Alternate Primary Account Number")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Amount ICCR")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Y", value = "ATM Pos Flag")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "U68FRGDFA", value = "Banknet Reference Number")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "543267", value = "Bridging ICA")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ACT", value = "Business Activity")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10.00", value = "Cash Back Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Cash Back Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "This field indicates the specific conditions present at the point of service (POS) at the time that a transaction takes place.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "005020examplebank", value = "For Mexico domestic credit card cash advance ATM transactions")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9C0", value = "Code that describes the PAN entry, PIN entry, and authorization mode of a transaction.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "Corporate Card Indicator")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0040110760000100", value = "For Mexico domestic credit card cash advance ATM transactions.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "Any transaction on a credit or debit card branded by Mastercard processed through the Single Message System in which the cardholder country code differs from the merchant country code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.00", value = "Currency Conversion Assessment amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Currency Conversion Assesement Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Y", value = "Compares the currency of the cardholder with the merchant’s country currency when the cardholder performs a transaction in another country")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "C", value = "Debit Mastercard field only. A value of C indicates that the merchant participates in the Mastercard CVC 2 Validation Program")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The document Indicator field indicates whether documentation is sent supporting the chargeback")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123456789", value = "Fees Inter Chg Acq Loc")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AA", value = "Financial Institution ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "010119", value = "Fraud Date")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Fraud Device Type")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AA", value = "Fraud Type")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7806", value = "Advice reason code that identifies the Global Clearing Management System (GCMS) message reason code when an exception item is processed")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "180624", value = "GCMS Settlement Date")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Issuer Adjustment Settlement Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DR", value = "Issuer Adjustment Settlement Amount Indicator")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Issuer Adjustment Settlement Completion Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Issuer Adjustment Settlement Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4900085", value = "Issuer Advice Reason Code.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "11000000", value = "Conversion rate used to convert amounts from the local transaction currency to the settlement currency.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "728345", value = "Issuer ICA")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1900053380", value = "Issuer institution ID Displays the routing and transit number of the customer. If the customer has no routing and transit number, i.e., the institution is International, then the number displayed is the pseudo number assigned by Mastercard.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Issuer Interchange Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Issuer Interchange Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9000001608", value = "Issuer processor number")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10.00", value = "The settlement amount is displayed in the issuers chosen settlement currency, as processed in the Single Message System")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Current issuer settlement currency code.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "11000000", value = "Issuer Settlement Conversion Rate")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10.00", value = "The monetary value appearing in this field represents the original completed amount of the transaction expressed in local currency.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A", value = "MC Electronic Indicator")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AA", value = "MC Response Value")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ABCD", value = "Merchant Category Code Info")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10.00", value = "Amount the cardholder is billed by the issuing institution. The Cardholder Billing Amount is displayed with the local currency code and the decimal positioning of the local currency code.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Original CardHolder Billing Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Original Cashback Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Original Cashback Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "This field is displayed only for partial approval transactions. The monetary value appearing in this field represents the original transaction amount expressed in local currency.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "s060972", value = "Owner ID")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Point Of Service Amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Point Of Service Currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "101001000150084048111-1234", value = "Displays the contents of Point of Service [POS] Data, which contain terminal and other Point of Service information")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "901", value = " Indicates the method used to enter the PAN into the terminal device and the PIN entry capability of that device.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5555666677778888", value = "Primary Account Number Sequence Number")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MCD", value = "Provides issuers additional information about Product ID, also known as product code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Q", value = "A special Debit Mastercard promotion program code displayed from GCMS.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "I", value = "Debit Mastercard field only. A value of I indicates that the transaction is not eligible for a chargeback with reason codes 0001, 0002 or 0037")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DMC20100", value = "The retrieval reference number from the original transaction is typically printed on the cardholders transaction receipt. This field is populated by the acquirer.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ABC", value = "Service Level Indicator")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "051018", value = "Date (month and day) that Mastercard uses to group the transactions for reporting and for subsequent settlement: Format: MMDDYY")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "010119", value = "Settlement Date Position")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "000", value = "Settlement Service Configuration (SSC) records define the business day and time of settlement for a transaction. The Settlement Service Configuration Indicator (SSC ID) describes which Single Message System Settlemetn Service record was used for the transaction.�� The SSC ID is assigned to a transaction based on a combination of the following values: product, interchange type, ISIS agreement, and region.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "This field will identify an eligible transaction with the a specific identifier of the related program.� Transactions that are not eligible will be identified with value N.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123455", value = "Switch Serial Number Position")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "093022", value = "Time that Mastercard routes the transaction to the issuer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "M1_I1 8", value = "The Terminal ID is the unique identification number assigned by the acquirer to each terminal")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Z", value = "Transaction Category Code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MS ATM DOM", value = "Displays the Transaction Class. For transactions submitted to the Single Message System, this field consists of the following: the source product type, the entry device, and fee classification")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "010129", value = "Date and time a message was transmitted by a processing entity, to be expressed in Coordinated Universal Time (UTC).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ABCDE", value = "Transit Data")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A", value = "Tran Type")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Universal Cardholder Authentication Field (UCAF) displays data systems used to communicate authentication information among cardholder, issuer, merchant, and acquirer communities")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Chargeback and retrieval request usage codes. The usage code indicates the type of chargeback record processed.")
