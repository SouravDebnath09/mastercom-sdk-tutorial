...
import com.mastercard.api.mastercom.model.CaseFilingStatusResponseStructure;
...
public class CaseFilingStatusResponse {
  ...
  private List<CaseFilingStatusResponseStructure> caseFilingResponseList = null;
  ...
  public CaseFilingStatusResponse addCaseFilingResponseListItem(CaseFilingStatusResponseStructure caseFilingResponseListItem) {
    if (this.caseFilingResponseList == null) {
      this.caseFilingResponseList = new ArrayList<CaseFilingStatusResponseStructure>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "A list of case filing statuses")
