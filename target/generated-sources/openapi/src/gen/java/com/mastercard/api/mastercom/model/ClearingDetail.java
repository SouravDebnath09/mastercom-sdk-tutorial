...
import com.mastercard.api.mastercom.model.InstallmentParameters;
import com.mastercard.api.mastercom.model.OriginalInformationInstallments;
...
public class ClearingDetail {
  ...
  **/
  ...
  @ApiModelProperty(example = "N", value = "Describes the category code of Account Level Management assigned")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "25131304365000000033393", value = "Data an acquirer supplies in an acquirer-originated message that may be required for an issuer to return to the acquirer in a subsequent message")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "999663", value = "Identifies the acquiring institution (for example, merchant bank) or its agent.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "97574B", value = "A code the authorizing institution assigns indicating approval")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "01", value = "A two-digit numeric subfield (such as 01, 02, or 03) that identifies a reconciliation period in a Business Date")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "A one position numeric value that identifies the business relationship between the transaction's participants")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10001", value = "A six-position value that identifies the business service to which the transaction is assigned for reconciliation and rules basis")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5411", value = "Classifies the type of business applicable to the card acceptor")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "Indicate whether Card Acceptor Business Code (MCC) override rates, Card Acceptor Business (CAB) Type override rates, or neither, were used in the interchange fee amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "USA", value = "Contains the card acceptor county of the merchant or, if a payment facilitator is involved in the transaction, the sub-merchant")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "375555569895", value = "Identifies the card acceptor ID assigned by the acquirer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "63102", value = "Contains the card acceptor's postal code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Gateway Arch Trail", value = "Contains the card acceptor's street address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "73429189", value = "A unique code identifying a terminal at the card acceptor location")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "www.amazon.com", value = "Contains the card website URL address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9", value = "Indicates whether the terminal has card capture capabilities")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5", value = "Indicates the terminal capabilities for transferring the data on the card into the terminal")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "R", value = "Indicates how the card data was entered at the terminal")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Indicates the ability of the terminal to write or output data to a card")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9", value = "Indicates the entity through which the cardholder's identity was verified at the point of service")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9", value = "Indicates the method by which the cardholder's identity was verified at the point of service")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2500", value = "The transaction amount in the issuers currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Identifies the currency code of the cardholder billing amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "00", value = "Describes the cardholder from account type")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "00", value = "Describes the cardholder to account type")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9000000959", value = "Issuer provided when processing retrieval or chargeback messages")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Indicates if the card is present at the point of service")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MCC", value = "A three-character code that identifies the card program or financial network to which a transaction belongs")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "210127", value = "Identifies the official business processing date when the business service reconciles a transaction")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "210127", value = "Central site processing date of original message")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Defines the cardholder billing amount currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Defines the reconciliation amount currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Defines the local transaction amount currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Explicitly identifies the implicit decimal point locations associated with cardholder billing amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Explicitly identifies the implicit decimal point locations associated with reconciliation amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Explicitly identifies the implicit decimal point locations associated with transaction amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Contains message text data, file update data, or other information as specified in individual IPM messages")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Indicates the type of Cardholder Authentication used in the authorization process")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Indicates the presence and type of security protocol present in the authorization process")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Identifies the level of UCAF™ supported in the authorization process")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5258", value = "Identifies a message's forwarding institution")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "50.00", value = "Contains total installment amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1200", value = "Installment fee contains any fee paid to or by the issuer in an installment transaction. Numeric value where the last 2 are decimal")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3", value = "Indicates which installment number is being submitted")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0040710D100003466878;2929985C876543456687;1929985D876543456687", value = "The field will contain the Additional Amount Data")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "21", value = "Indicates the specific installment plan types ... 21,22,23")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "200", value = "Indicates a message's specific purpose")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MPL", value = "Identifies the product recognized by GCMS for the combination of issuer account range and Card Program Identifier")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "20", value = "Contains the type of financing applicable for the installment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Contains the annual percentage rate (XXX.XX%) an issuer will charge the cardholder for the installment payments. For installmentpayments, the default is all spaces")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "24", value = "Identifies the amount of the first installment payment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Contains the fee amount an issuer will charge the cardholder for the installment payments in cardholder billing currency. The default is all spaces.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "23", value = "Identifies the interest rate of intallment payments")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Identifies the number of installment payments")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "20", value = "Contains the fee amount an issuer will charge the cardholder for the installment payments in cardholder billing currency. The default is all spaces.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100", value = "Contains data related to ICC systems")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "79", value = "Indicates the interchange rate and editing rules applied to the transaction")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MPL", value = "Identifies the actual product code assigned by Mastercard when licensing the combination of issuer account range and Card Program Identifier")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Amazon", value = "Provides the card acceptor's legal corporation name")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3 positions = 130 [First Chargeback]", value = "Indicate a particular chargeback domestic reason code(only for Chargebacks)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "006", value = "Contains the VAT amount for the installment fee. Numeric value where the last 2 are decimal.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "210127010100", value = "The local year, month, day, and time at which the transaction takes place at the card acceptor location.The seconds in time will always be set to 00")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PDS176", value = "Identifier assigned by Mastercard")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "Indicates whether override rates were used in the interchange fee amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5154676300000001", value = "Provides either the virtual account number/token or the primary account number in a transaction for which Mastercard performed the mapping service")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "Populated by GCMS and identifies the transaction as having received the Masterpass-Enabled Merchant Incentive")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1401", value = "Contains the initial transaction's Message Reason Code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "15", value = "Total number of installments to be submitted")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Provides the message format in which the clearing system received a message")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PDS190", value = "Identifies a specific partnership agreement, generally between specific card acceptors and issuers.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Indicates the maximum number of PIN characters that the POS terminal can capture")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "00", value = "Identifies the entity to be debited and the entity to be credited for the fee amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Y", value = "Product Class value to indicate whether product class override interchange rates were used in the interchange fee amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "C57", value = "Monitors and tracks a participant's activity in special promotion programs (primarily U.S.-defined).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "I", value = "Indicates whether or not the Quick Payment Service (QPS) or PayPass transaction qualifies for chargeback protection")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "Indicates the rate applied by GCMS to the transaction")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2202", value = "Identifies the receiving institution")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2500", value = "The transaction amount value converted to the customer's reconciliation (that is, the customer's payment or settlement) currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Identifies the currency code of the reconciliation amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Identifies the domain in which the Service Manager (program originator) of the Mobile Remote Payments Program is operating")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "200", value = "Provides codes that increase issuers' flexibility in defining card acceptance parameters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Provides reconciliation and settlement information for each clearing system transaction that has settlement impact")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "M", value = "Indicates the settlement impact of amounts in an IPM message")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "N", value = "Indicates whether an adjustment was included in the Fee amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Indicates the print and display capabilities of the terminal")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Indicates whether the card acceptor is attending the terminal and the location of the terminal")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CT6", value = "Identifies the type of terminal used at the point of interaction")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4GFCYTH29Z", value = "Contains the ID assigned by the token service provider to the token requestor")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "250.00", value = "Contains total transaction amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "02", value = "Provides information about the transaction that cannot be determined from other transaction information, such as Primary Account Number or Point of Service Data Code")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "840", value = "Defines the currency code of the transaction")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2705", value = "Identifies the transaction destination institution")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MPL2OSTCV0728", value = "Contains all life cycle messages such as Authorizations, Financials, Reversals, Retrievals, Fulfillments and Chargebacks")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5258", value = "Identifies the transaction originator institution")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Clearing", value = "Describes the specific cardholder transaction type")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "05", value = "Provides data related to the transit transaction type and the transaction mode")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "101", value = "Provides information about transactions initiated through the use of a digital wallet")
